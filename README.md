...
>
> ```diff
> - The iNaturalist API calls are returning too much data currently causing most of the
> - requests to be rejected and causing the MCP server's clients to become unstable.
